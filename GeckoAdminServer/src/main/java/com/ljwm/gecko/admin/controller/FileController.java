...
public class FileController extends BaseController {
  ...
  public Result<String> upload(@RequestParam("file") MultipartFile file, @RequestParam @Valid String folder) {
    String fileName = FileKit.saveUploadFile(file, appInfo.getFilePath(), folder);
