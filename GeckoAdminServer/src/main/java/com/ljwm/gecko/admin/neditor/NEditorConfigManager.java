 ...
 */
public class NEditorConfigManager {
  ...
  /*
     ...
     */
  private NEditorConfigManager(String env) {
    this.initEnv(env);
  }
   ...
   */
  public static NEditorConfigManager getInstance(String env) {
    try {
      return new NEditorConfigManager(env);
    } catch (Exception e) {
      return null;
    }
  }
  ...
  public Map<String, Object> getConfig(int type, String rootPath) {
    ...
    switch (type) {
      ...
      case ActionMap.UPLOAD_SCRAWL:
        conf.put("filename", NEditorConfigManager.SCRAWL_FILE_NAME);
      ...
      case ActionMap.CATCH_IMAGE:
        conf.put("filename", NEditorConfigManager.REMOTE_FILE_NAME);
  ...
  private void initEnv(String env) {
